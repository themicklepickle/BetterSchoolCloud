...
const setElementDisplays = () => {
  ...
  document.getElementsByClassName("percentagePosition")[0].style.display =
    percentages.checked ? "block" : "none";
  ...
  if (betterTableLayout.checked && percentagePosition.length === 5) {
    if (percentagePosition.value === "6") percentagePosition.value = "5";
